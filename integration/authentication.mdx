...
Once authenticated, you can retrieve your account details and subscription information:
...
- Checking your current API quota and usage
- Displaying account information in your application
